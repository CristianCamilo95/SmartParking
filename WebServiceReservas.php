...
include_once("ClassControladoraR.php");

$Parametro="";
switch ($method) {
    case 'GET'://el get es para consulta	
		$arguments=$_GET;
		$Obj1=new controladoraR('','','','','');
	    $Obj1->Mostrar();
		$Registros=$Obj1->getR();
    ...
    case 'POST': 
		...
		$Obj1=new controladoraR($arguments['Idreserva'],$arguments['Cliente'],$arguments['Costo'],$arguments['Parqueadero'],$arguments['TipoVehiculo']);
        $Obj1->ingresar();		
		$Registros=$Obj1->getR();		
		$response=$Registros;
        break;
